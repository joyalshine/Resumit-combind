...
function DataValidationJoyal({ parsedData, reqType }) {
    ...
    useEffect(() => {
        if (reqType == "validate") {
            ...
            setSkillDetailsArray(parsedData.skills)
    ...
    const handleSubmitBasic = () => {
        if (basicDetails.name == '' || basicDetails.linkedin == '' || basicDetails.github == '' || basicDetails.location == '' || basicDetails.email == '') {
    ...
    const handleSubmitSkills = () => {
        if (skillDetailsArray.frontend.length == 0 && skillDetailsArray.backend.length == 0 && skillDetailsArray.app.length == 0 && skillDetailsArray.others.length == 0) {
            setShowAlertMsg("Enter at least 1 skill")
            setShowAlert(true)
            setTimeout(() => {
                setShowAlert(false)
            }, 5000)
    ...
    const handleSubmitAbout = async () => {
        ...
        try {
            if (about == '') {
                ...
                if (reqType == "validate") {
                    await createPortfolio({ basicDetails, skillDetailsArray, projectArray, about, template: 'joyal' }).then(({ status, url }) => {
                        if (status) {
                    ...
                    await updatePortfolio({ basicDetails, skillDetailsArray, projectArray, about, _id: parsedData._id }).then(({ status, url }) => {
                        if (status) {
                            Swal.fire({
                                position: "center",
                                icon: "success",
            ...
            <div className='w-full sm:mt-20 mt-10 sm:p-5 p-3'>
                <div className='w-full flex justify-center relative z-0'>
                    <ol class="flex items-center w-full sm:w-3/4 flex justify-center text-xs text-gray-900 font-medium sm:text-base">
                        ...
                        <li class={`flex relative transition duration-500  ${activeStep > 4 ? "after:bg-indigo-600 text-indigo-600" : "after:bg-gray-200 text-gray-900"}`}>
                            <div class="block whitespace-nowrap z-10">
                ...
                {activeStep == 1 ? <div className='sm:px-24 flex flex-col mt-20'>
                        ...
                        <form onSubmit={(e) => {
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" value={basicDetails.location} onChange={(e) => setBasicDetais({ ...basicDetails, location: e.target.value })} id="last_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Doe" required />
                                </div>
                            </div>
                            <div class="mb-6">
                    ...
                    <div className='w-full flex justify-center'>
                        <div className='sm:px-24 w-full md:w-2/3 flex flex-col mt-20'>
                            ...
                            <div className='mt-5'>
                                <div>
                                    <label for="first_name" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Frontend Skills</label>
                                    <div className=' border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'>
                                        <div className='bg-gray-50 border border-gray-300 p-2 mb-2 rounded-lg flex flex-wrap'>
                                            {skillDetailsArray.frontend.map((item, index) => {
                                                return (<span id={`badge-dismiss-indigo-${index}`} key={index} class="inline-flex items-center px-2 py-1 m-1 text-sm font-medium text-indigo-800 bg-indigo-100 rounded dark:bg-indigo-900 dark:text-indigo-300">
                                                    ...
                                                    <button type="button" onClick={() => {
                                                        let frontend = skillDetailsArray.frontend.filter(x => x != item);
                                                        setSkillDetailsArray({ ...skillDetailsArray, frontend })
                                        ...
                                        <div>
                                            <div class="relative">
                                                <form action="">
                                                    <input type="search" value={skillDetails.frontend} onChange={(e) => setSkillDetails({ ...skillDetails, frontend: e.target.value })} id="search" class="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter the skill" required />
                                                    <button type="submit" onClick={(e) => {
                                                        e.preventDefault()
                                                        if (skillDetails.frontend != '') {
                                                            skillDetailsArray.frontend.push(skillDetails.frontend)
                                                            setSkillDetails({ ...skillDetails, frontend: '' })
                                                        }
                                ...
                                <div className='mt-5'>
                                    <label for="first_name" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Backend Skills</label>
                                    <div className=' border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'>
                                        <div className='bg-gray-50 border border-gray-300 p-2 mb-2 rounded-lg flex flex-wrap'>
                                            {skillDetailsArray.backend.map((item, index) => {
                                                return (<span id={`badge-dismiss-indigo-${index}`} key={index} class="inline-flex items-center px-2 py-1 m-1 text-sm font-medium text-indigo-800 bg-indigo-100 rounded dark:bg-indigo-900 dark:text-indigo-300">
                                                    {item}
                                                    <button type="button" onClick={() => {
                                                        let backend = skillDetailsArray.backend.filter(x => x != item);
                                                        setSkillDetailsArray({ ...skillDetailsArray, backend })
                                                    }} class="inline-flex items-center p-1 ms-2 text-sm text-indigo-400 bg-transparent rounded-sm hover:bg-indigo-200 hover:text-indigo-900 dark:hover:bg-indigo-800 dark:hover:text-indigo-300" data-dismiss-target={`#badge-dismiss-indigo-${index}`} aria-label="Remove">
                                                        <svg class="w-2 h-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                                        </svg>
                                        ...
                                        <div>
                                            <div class="relative">
                                                <form action="">
                                                    <input type="search" value={skillDetails.backend} onChange={(e) => setSkillDetails({ ...skillDetails, backend: e.target.value })} id="search" class="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter the skill" required />
                                                    <button type="submit" onClick={(e) => {
                                                        e.preventDefault()
                                                        if (skillDetails.backend != '') {
                                                            skillDetailsArray.backend.push(skillDetails.backend)
                                                            setSkillDetails({ ...skillDetails, backend: '' })
                                                        }
                                                    }} class="text-white absolute end-2.5 bottom-2 text-sm bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                                                </form>
                                            </div>
                                ...
                                <div className='mt-5'>
                                    <label for="first_name" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">App Skills</label>
                                    <div className=' border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'>
                                        <div className='bg-gray-50 border border-gray-300 p-2 mb-2 rounded-lg flex flex-wrap'>
                                            {skillDetailsArray.app.map((item, index) => {
                                                return (<span id={`badge-dismiss-indigo-${index}`} key={index} class="inline-flex items-center px-2 py-1 m-1 text-sm font-medium text-indigo-800 bg-indigo-100 rounded dark:bg-indigo-900 dark:text-indigo-300">
                                                    {item}
                                                    <button type="button" onClick={() => {
                                                        let app = skillDetailsArray.app.filter(x => x != item);
                                                        setSkillDetailsArray({ ...skillDetailsArray, app })
                                                    }} class="inline-flex items-center p-1 ms-2 text-sm text-indigo-400 bg-transparent rounded-sm hover:bg-indigo-200 hover:text-indigo-900 dark:hover:bg-indigo-800 dark:hover:text-indigo-300" data-dismiss-target={`#badge-dismiss-indigo-${index}`} aria-label="Remove">
                                                        <svg class="w-2 h-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                                        </svg>
                                        ...
                                        <div>
                                            <div class="relative">
                                                <form action="">
                                                    <input type="search" value={skillDetails.app} onChange={(e) => setSkillDetails({ ...skillDetails, app: e.target.value })} id="search" class="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter the skill" required />
                                                    <button type="submit" onClick={(e) => {
                                                        e.preventDefault()
                                                        if (skillDetails.app != '') {
                                                            skillDetailsArray.app.push(skillDetails.app)
                                                            setSkillDetails({ ...skillDetails, app: '' })
                                                        }
                                                    }} class="text-white absolute end-2.5 bottom-2 text-sm bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                                                </form>
                                            </div>
                                ...
                                <div className='mt-5'>
                                    <label for="first_name" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Other Skills</label>
                                    <div className=' border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'>
                                        <div className='bg-gray-50 border border-gray-300 p-2 mb-2 rounded-lg flex flex-wrap'>
                                            {skillDetailsArray.others.map((item, index) => {
                                                return (<span id={`badge-dismiss-indigo-${index}`} key={index} class="inline-flex items-center px-2 py-1 m-1 text-sm font-medium text-indigo-800 bg-indigo-100 rounded dark:bg-indigo-900 dark:text-indigo-300">
                                                    {item}
                                                    <button type="button" onClick={() => {
                                                        let others = skillDetailsArray.others.filter(x => x != item);
                                                        setSkillDetailsArray({ ...skillDetailsArray, others })
                                                    }} class="inline-flex items-center p-1 ms-2 text-sm text-indigo-400 bg-transparent rounded-sm hover:bg-indigo-200 hover:text-indigo-900 dark:hover:bg-indigo-800 dark:hover:text-indigo-300" data-dismiss-target={`#badge-dismiss-indigo-${index}`} aria-label="Remove">
                                                        <svg class="w-2 h-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                                        </svg>
                                        ...
                                        <div>
                                            <div class="relative">
                                                <form action="">
                                                    <input type="search" value={skillDetails.others} onChange={(e) => setSkillDetails({ ...skillDetails, others: e.target.value })} id="search" class="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter the skill" required />
                                                    <button type="submit" onClick={(e) => {
                                                        e.preventDefault()
                                                        if (skillDetails.others != '') {
                                                            skillDetailsArray.others.push(skillDetails.others)
                                                            setSkillDetails({ ...skillDetails, others: '' })
                                                        }
                                                    }} class="text-white absolute end-2.5 bottom-2 text-sm bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                                                </form>
                                            </div>
                        ...
                        <div className='sm:px-24 flex flex-col mt-20'>
                            ...
                            <div className='mt-5'>
                                <form onSubmit={(e) => {
                                    ...
                                    <div class="mb-6">
                                        <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Give Short Introduction about yourself</label>
                ...
                <div className='sm:px-24 flex justify-between my-10'>
                    ...
                    <button type="button" onClick={handleFunctions[activeStep - 1]} class={`text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 ${activeStep == 6 ? "cursor-not-allowed" : ""}`}>Next</button>
                </div>
            </div>
...
export default DataValidationJoyal

import './DataValidationJoyal.css'
                    ...
                    return <div className="project-item w-full lg:w-2/3">
                        <div className="project-desc-left">
                            ...
                            <div className="links">
                                ...
                                {item.figma != '' ? <a href={item.figma} target="_blank" rel="noreferrer">Figma<i className="fa-brands fa-figma"></i></a> : <></>}
                            </div>
                            <div className='flex justify-end'>
                                <button type='button' onClick={() => {
                                    ...
                                    <svg class="w-6 h-6 text-gray-800 dark:text-white text-[#3b82f6]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <div className='mt-1'>
                <form onsubmit={(e) => {
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            <label for="website" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Figma Link</label>
                            <input type="url" value={projectDetails.figma} onChange={(e) => setProjectDetails({ ...projectDetails, figma: e.target.value })} id="website1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="flowbite.com" required />
                        </div>
                    </div>
                    <div class="mb-6">
