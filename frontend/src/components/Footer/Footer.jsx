    ...
    return (
        <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
            <div class="mx-auto max-w-screen-xl text-center">
                ...
                <p class="my-6 text-gray-500 dark:text-gray-400">Create Professional Resumes and Instantly Convert Them to Portfolios with AI-Powered Tools.</p>
                ...
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024-2025 <a href="#" class="hover:underline">Resume Builder</a>. All Rights Reserved.</span><br/>
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"> Developed by Arnab and Joyal.</span>
            </div>
        </footer>
    )
}
